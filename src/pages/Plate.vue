...
<style>
    ...
    min-width: 1200px;
    height: 40px;
    background-color: rgba(247,99,114,0.8);
  }
  .plate-nav-wrapper > a {
  ...
  .platenav-title > span .fa-angle-down {
  	position: absolute;
  	top: .8em;
  	right: 2em;
  }
  .plate-nav-wrapper > a:hover {
  ...
  .platenav-title:hover .platenav-block {
  	display: block;
  }
  .platenav-block > * > .title {
    font-size: 16px;
    font-weight: 600;
    color: #f76372;
    text-align: center;
  ...
  .platenav-block-type ul > li:nth-child(5) a {
    margin-right: 32px;
  }
